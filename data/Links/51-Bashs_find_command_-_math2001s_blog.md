...
type: bookmark
url: https://math2001.github.io/article/bashs-find-command/
---
...
`-name` takes a glob. The `-iname` variant is case insensitive. 
...
Same, you have `-ipath` for a case _insensitive_ version of it. 
